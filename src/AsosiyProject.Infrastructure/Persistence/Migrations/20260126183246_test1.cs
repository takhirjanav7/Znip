        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoogleProfilePictureUrl = table.Column<string>(type: "text", nullable: true),
                    ...
                    CoverPictureUrl = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    SkillsList = table.Column<string>(type: "text", nullable: true),
                    Rating = table.Column<double>(type: "numeric(3,2)", precision: 3, scale: 2, nullable: false, defaultValue: 0.0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProficiencyLevel = table.Column<int>(type: "integer", nullable: false, defaultValue: 50),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserSkills_AppUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AppUsers",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUsers_Rating",
                table: "AppUsers",
                column: "Rating");

            migrationBuilder.CreateIndex(
                name: "IX_AppUsers_TotalRatings",
                table: "AppUsers",
                column: "TotalRatings");
